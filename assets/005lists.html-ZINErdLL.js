import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as i,e}from"./app-G8jnKdhm.js";const a={},l=e(`<p>Markdown 支持无序列表和有序列表。</p><p>这两种列表都是块元素。</p><h2 id="无序列表" tabindex="-1"><a class="header-anchor" href="#无序列表" aria-hidden="true">#</a> 无序列表</h2><p>使用 <code>-</code>、<code>*</code> 或 <code>+</code> 创建一个无序列表。其中 <code>[-*+] text</code> 称为一个列表项。</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code><span class="token list punctuation">-</span> 使用 <span class="token code-snippet code keyword">\`-\`</span> 创建的无序列表1
