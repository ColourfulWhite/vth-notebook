import{_ as c}from"./favicon-GHtoPB5P.js";import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as u,c as i,a as n,b as s,d as e,w as d,e as a}from"./app-G8jnKdhm.js";const k={},r=a(`<h2 id="块引用" tabindex="-1"><a class="header-anchor" href="#块引用" aria-hidden="true">#</a> 块引用</h2><p>在 Markdown 中使用 <code>&gt;</code> 创建一个块引用，语法是 <code>&gt; text</code>，其中 <code>&gt;</code> 与文本之间的空格是必须的。</p><p>块引用是一个块元素。</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code><span class="token blockquote punctuation">&gt;</span> Markdown is markup language.
